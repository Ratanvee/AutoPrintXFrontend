...
// // Add this import
// import { recentActivity as fetchRecentActivity } from "./api/endpoints"
...
//   // Replace the hardcoded recentActivity state with useQuery
...
//   // ✅ Fetch dashboard overview with auto-refresh
...
//       <div className="dashboard-header-section">
//         <motion.h1 variants={itemVariants}>Dashboard Overview</motion.h1>
//         <a href={dashboardOverviewData ? `/upload/${dashboardOverviewData.OrderOverview[0].unique_url}` : '#'}>
//           /upload/{dashboardOverviewData ? dashboardOverviewData.OrderOverview[0].unique_url : 'Loading...'}
//         </a>
//         <div className="time-range-selector">
//           {["24h", "7d", "30d", "90d"].map((range) => (
//             <button
